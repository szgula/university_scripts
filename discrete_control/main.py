...
# world and object observations
pendulum_angle = []
pendulum_desire_angle = []
object_speed = []
object_desire_speed = []
object_position = []
object_desire_position = []
...
def correction():
    ...
    global object_speed, object_desire_speed
    global object_position, object_desire_position
    global pendulum_angle, pendulum_desire_angle
    global global_time, plt

    object_speed.append(speed)
    object_desire_speed.append(myBot.xp)
    pendulum_angle.append(myBot.phi)


    if (use_pid):
        global_time += 1
        #plt.scatter(global_time, round(myBot.phi, 3))
        #plt.show()
        #plt.pause(0.000001)
